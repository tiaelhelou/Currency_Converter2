...
$length = count($jo->buy); // Getting the length of the array 

$updated_buy = intval($jo->buy[$length - 1][1]); // Getting updated rate of the sell which is the last element in the array
